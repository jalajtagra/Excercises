...
(function (e) {
    ...
    e.jqPagination = function (t, n) {
        ...
        r.init = function () {
            ...
            r.$input.on("blur.jqPagination keydown.jqPagination", function (t) {
                var n = e(this), i = parseInt(r.options.current_page, 10);
                if (t.keyCode === 27) {
                    n.val(i);
                    n.blur()
                }
        ...
        r.setPage = function (e, t) {
            ...
            var n = parseInt(r.options.current_page, 10), i = parseInt(r.options.max_page, 10);
        ...
        r.setInputValue = function (e) {
            var t = r.options.page_string, n = r.options.max_page;
        ...
        r.setLinks = function (e) {
            var t = r.options.link_string, n = parseInt(r.options.current_page, 10), i = parseInt(r.options.max_page, 10);
            if (t !== "") {
                var s = n - 1;
                s < 1 && (s = 1);
                var o = n + 1;
    ...
    e.fn.jqPagination = function () {
        var t = this, n = e(t), r = Array.prototype.slice.call(arguments), i = !1;
